        ...
        <Row>
          ...
          <Col lg={3}>
            <ListGroup className="group">
              ...
              <ListGroup.Item  > <a href="#">Home</a></ListGroup.Item> 
                            <ListGroup.Item> <a href="#">Podcast</a></ListGroup.Item>
              <ListGroup.Item ><a href="#">Blog</a></ListGroup.Item>
              <ListGroup.Item ><a href="#">About</a></ListGroup.Item>
            </ListGroup>
          </Col>
          <Col lg={3}>
            <ListGroup>
          ...
          <Col lg={3}>
            <ListGroup>
              ...
              <ListGroup.Item>
                <img src={Apple} width={28} /> &nbsp; <a href="#">Apple Podcasts</a>
              </ListGroup.Item>
              <ListGroup.Item>
